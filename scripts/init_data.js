...
function createInit() {
    ...
    let grid_sizes = 'В данной курсовой работе проектируется средняя ячейка с размерами в плане ' + dataIn.paramL + '×' + dataIn.param_l + 'м.'
