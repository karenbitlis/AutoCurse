...
class Floor extends HTMLElement {
    connectedCallback() {
        // Сюда пишем весь HTML, который должен появиться на месте тега
        const shge = this.attachShadow({ mode: 'open' });
        shge.innerHTML = `
            <style>
                body {
                    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            ...
            <div class="container">
                <h2>Выбор типа пола</h2>
                <form class="form-container">
                    <h3>Тип пола</h3>
                    <div class="form-group">
                        <label id="floorExplanation"></label>
                        <div class="form-r">
                            <label class="radio-card">
                                <input type="radio" name="delivery_method" value="courier" id="floorChoice1" checked>
                                <img src="img/floor1.jpg" class="picPick">
                            </label>
                            <label class="radio-card" id="radio-card1">
                                <input type="radio" name="delivery_method" value="pickup" id="floorChoice2">
                                <img src="img/floor2.jpg" class="picPick">
                            </label>
                        </div>
                    </div>
                </form>
                <button id="generate-btn">Скачать сбор нагрузок на настил</button>
            </div>
        `;}}
customElements.define('floor-type', Floor);

class DeckRoof extends HTMLElement {
    connectedCallback() {
        ...
        sha.innerHTML = `
            ...
            <div class="container" id="withCanvas">
                ...
                <div class="form-row">
                    ...
                    <div>
                        <h1 id="deck_thickness"></h1>
                        <h3>
                            <select id="decking_varo">
                ...
                <button id="decking">Скачать расчет</button>
            </div>
        `;}}
customElements.define('deck-roof', DeckRoof);

class RoofBeam extends HTMLElement {
    connectedCallback() {
        // Сюда пишем весь HTML, который должен появиться на месте тега
        const sha = this.attachShadow({ mode: 'open' });
        sha.innerHTML = `
        ...
        `;}}
customElements.define('roof-beam', RoofBeam);

class RoofEpure extends HTMLElement {
    connectedCallback() {
        // Сюда пишем весь HTML, который должен появиться на месте тега
        const sha = this.attachShadow({ mode: 'open' });
        sha.innerHTML = `
            ...
            <div class="container" id="withCanvas">
                ...
                <div class="form-row">
                    <button id="epure_only">Скачать эпюры</button>
                    <button id="epuring">Скачать расчеты</button>
                </div>
            </div>
        `;}}
...
class SecEpure extends HTMLElement {
    connectedCallback() {
        // Сюда пишем весь HTML, который должен появиться на месте тега
        const sha = this.attachShadow({ mode: 'open' });
        sha.innerHTML = `
            ...
            <div class="container" id="withCanvas">
                <h2>Эпюры второстепенной балки</h2>
                <div class="form-row">
                    <h1 id="sEpure-result"></h1>
                    <h3>
                        <select id="secep_varo">
                            <option value="1"><h1>Вариант 1</h1></option>
                            <option value="2"><h1>Вариант 2</h1></option>
                            <option value="3"><h1>Вариант 3</h1></option>
                        </select>
                ...
                <div class="form-row-triple">
                    <button id="sec_epure_sw">Построить<br>нормативные эпюры</button>
                    <button id="sec_epure_only">Скачать эпюры</button>
                    <button id="sec_epuring">Скачать расчеты</button>
                </div>
            </div>
        `;}}
